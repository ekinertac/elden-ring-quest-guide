const questData = {
    "main": [
        ...
        },
        {
            ...
            "tasks": [
                "Find and speak with Irina past the Bridge of Sacrifice on the way to the Weeping Peninsula and accept a letter.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Rogier in the chapel. Purchase something from him, Then speak with him again.",
                ...
                "Travel back to where you found the Chrysalid’s memento for Roderika’s crimson hood."
            ]
        },
        {
            "title": "Southeast Liurnia",
            "tasks": [
                "Find and speak with Hyetta at the Lake-Facing Cliffs Grace. Give her the Shabiri Grape from under the throne room of the castle.",
                "Reload the area and talk to Boc at the Lake-Facing Cliffs Grace.",
                "Find and speak with Thops at the Church of Irith next to the Lake-Facing Cliffs Grace.",
                "Travel to the Purified Ruins on the shore of East Liurnia and find the hidden floor in the center to grab the Shibiri Grape. Find Hyetta in the Western side of the ruins and give her the grape.",
                ...
                "Find and speak with Miriel at the church of vows. Exhaust his dialogue for some good lore. Use Celestial Dew to “atone” at the Church of Vows.",
                "Collect the Gold Sewing Needle from the Church of Vows (for Boc’s questline).",
        ...
        {
            "title": "Central Liurnia",
            "tasks": [
                "Collect the map at the Academy Gate Town Grace, and go North and talk to Diallos. Then, travel to Roundtable Hold and talk to Diallos again.",
                "Speak with Patches on the Scenic Isle near the Laskyar Ruins Grace.",
                "East of the Scenic Isle, meet Rya. in a pavilion and offer to help.",
                "Find and speak with Blackguard Big Boggart at the Boilprawn Shack, North of the Scenic Isle. Offer to buy the necklace. Then, buy some boiled prawns. Go back to speak to Rya.",
                ...
                "Travel North to talk to White-Faced Varre at the Rose Church. To continue his quest, either perform 3 invasions (outcome doesn’t matter) or later use Magnus the Beast Claw's invasion sign at Writheblood Ruins as the offline route. Then speak with him again.",
                "Find and speak with Edgar at the Revenger’s Shack, west of the Rose Church, and get a Shabiri Grape.",
                "Collect the Glintstone Key, found near the island west of the Academy, guarded by a dragon, and head to the Academy. After using the key, but before entering the Academy, walk past the seal going North, and interact with a red summon sign. Help Yura kill the invader. Then speak with him after the fight.",
        ...
        {
            "title": "Northwestern Liurnia (South to North)",
            "tasks": [
                "Travel North up the hill from the Revenger's shack to reach the Four Belfries. Use the imbued stonesword key, from the chest nearby, on the Northeastern Belfry. Go through the portal to get the Stormhawk King Ashes (for Nepheli's quest).",
                "Speak with Iji, sitting next to the main road.",
                "Travel through Caria Manor and speak to Ranni. Then, go back and forth exhausting the dialogue with Rogier and Ranni. After joining Ranni’s service, return to Rogier.",
                "Speak with the summons of Blaidd, Iji, and Seluvis. Then speak with Ranni again.",
                "Travel to Seluvis’ Rise nearby to speak to Seluvis. Seluvis's full questline must be completed (through Altus Plateau) before completing Nokron, and you will need to atone at the Church of Vows afterwards, so you may choose to skip his quest. To continue his quest, you must give the potion to 1 of 3 people. 1) Nepheli- this will give you a unique item, but end Nepheli's questline 2) Gideon - this won't change anything OR 3) Dung Eater, found much later in Leyndell - this will give you a unique item, but end Dung Eater's questline and prevent you from receiving one of the endings (not required for the trophy). The choice is yours.",
                "Speak with everybody in the Roundtable Hold. Go back and forth between Nepheli (who has moved downstairs) and Gideon until you give Nepheli an item. Give her 1) the potion from Seluvis, ending her questline OR 2) the Stormhawk King Ashes.",
        ...
        {
            "title": "Northeastern Liurnia",
            "tasks": [
                "Back in the Lake, head North. Just past The Ravine Site of Grace, turn right up a ramp. Talk to Hyetta at Bellum Church.",
                "Travel South to the East Raya Lucaria Grace. Tall to Boc and talk to Melina.",
                "Travel North and veer right, circling up the hill until you reach the Church of Inhibition. Kill Festering Fingerprint Vyke.",
                "Interact with the maiden in the chair at the Church of Inhibition. Return to Varre. Exhaust his dialogue.",
                "Give Hyetta the Fingerprint Grape at Bellum Church."
            ]
        },
        {
            "title": "Caelid/Dragonbarrow",
            "tasks": [
                "Follow the western Caelid cliffside to find Gael Tunnel. Go through and open the door for Alexander. Exhaust his dialogue.",
                "Speak with Alexander and Blaidd in Redmane Castle in South Caelid.",
                "Summon Blaidd and Alexander for the fight at Redmane, and Then speak with them nearby after the fight.",
                "Travel back to the Redmane castle plaza and walk toward the elevator. Talk to Witchhunter Jerren. (For Sellen's quest).",
                "Find and speak with Gowry in Gowry’s shack, South of Sellia. Get the needle by killing Commander O-Neil, in the swamp nearby under the tall tree. Summon Polyanna for the fight.",
                ...
                "Find and speak with Milicent at the Church of the Plague, accessed by lighting 3 braziers in Selia, which will open a path North of Selia. Give her the needle from Gowry. Reload the area and talk to her again.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "After arriving at the Altus Plateau, speak to everybody in the Roundtable Hold, ending with D and Dung Eater (past the Twin Maiden Husks). Speak with Fia until she gives you the Weathered Dagger, give it to D, then reload the area and go to the newly opened room past Hewg.",
                "Speak with Corhyn next to the map, slightly North of the Altus Highway Junction Grace.",
                "Find Yura at the Second Church of Marika, North of the Altus Highway Junction Grace.",
                "Collect the Amber Starlight for Seluvis in a grotto East of Corhyn. *Return to Seluvis. Exhaust his dialogue (including purchasing both puppets), reload the area, then exhaust his dialogue again. Follow his instructions (this will require \"attoning\" at the Church of Vows afterwards). Return to Seluvis and Pidia.",
                ...
                "Speak with Milicent at the Erdtree Gazing Hill. Return to speak to Gowry. Exhaust his dialogue, buy his incantation, exhaust his dialogue, then attack him. Reload the area and speak to him again.",
                "Travel North from Corhyn and take the portal next to the Forest Spanning Greatbridge Grace. Find Goldmask on the North end of the bridge. Talk to Corhyn, then reload the area and return to Goldmask.",
                "Travel through Windmill Village and talk to Milicent at the Windmill Heights Grace.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Just outside the Valiant Gargoyle boss room in Siofra Aqueduct, Give him D’s armor. Reload the area. Then, you can summon D to help fight the final boss.",
        ...
        {
            "title": "Mt. Gelmir / Sellen's Questline",
            "tasks": [
                "Deathroot #5 Just up the hill from the Erdtree Gazing Hill, defeat the mariner in the Wyndham Ruins.",
                "Speak with Alexander sitting in lava near the Seethewater Terminus (by a magma wyrm).",
                "In Hermit Village, pick up the “you’re beautiful” prattling pate (for Boc's questline).",
                "Speak with Primeval Sorcerer Azur at the edge of Hermit Village. Then, go talk to Sellen.",
                "Travel North of Church of the Plague in Caelid to find Selia Hideaway behind an illusory wall. Find Master Lusat. Talk to Selen.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Tanith to join the manor. (Note that there is no in-game consequence for joining the Volcano Manor. If you would rather not complete the requests, for ethical reasons, you can still join the manor to gain access.).",
                "Speak with everybody in the manor, including Patches in the hallway.",
                ...
                "In one of the manor's rooms, find an illusory wall. Continue that way, exploring everything you come across, until you get to the Prison Town Church Grace. Return to speak to Rya (in the newly opened room) and then Tanith.",
                ...
                "If ignoring assassination requests, complete the rest of Volcano Manor and complete the final boss (Rykard). Otherwise, leave Volcano Manor for now without completing the final boss. <span class=\"blocker-warning\">⚠️ BLOCKER: Defeating Rykard will immediately end all Volcano Manor assassination requests and Rya's questline. Complete them first!</span>"
            ]
        },
        {
            "title": "Leyndell",
            "tasks": [
                ...
                "Purchase Radhan's chest armor from Enia in the Roundtable Hold. Then speak with Boc at the East Capital Rampart Grace and give him the golden sewing needle.",
                ...
                "Speak with Blackguard in the Leyndell Moat. Reload the area and speak to him again. Read Dung Eater's message in the Roundtable Hold, then meet and defeat his invader form in the Outer Moat. Return to the Roundtable Hold to speak to Dung Eater.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Shabriri at the Zamor Ruins grace. He describes how you can save Melina. Following his advice now opens up more dialogue options, but it also requires that you fight the hardest bosses to get every ending. See the Frenzied Flame ending at the bottom of this list for more details.",
                "Deathroot #7 In a chest behind the boss in the Giants' Mountaintop Catacombs.",
                "Speak with Milicent at the Ancient Snow Valley Ruins Grace.",
                ...
                "Complete the final Volcano Manor quest. Return to Tanith to meet the Lord of Volcano Manor. Then speak with everybody in the manor. Return to the Rykard Lord of Blasphemy Grace to find Tanith again. Exhaust her dialogue.",
                ...
                "Speak with Patches in the Shaded Castle near the Castellan's Hall Grace. Return to Tanith and exhaust her dialogue. If you hit Tanith her knight will invade. Defeat him to earn a spell.",
        ...
        {
            "title": "Consecrated Snowfield / Haligtree",
            "tasks": [
                "Access the Consecrated Snowfield by getting both Medallion halves, going to the Grand Lift of Rold, and clicking left or right to “hoist secret medallion”.",
                ...
                "Travel to the Haligtree by completing the puzzle at Ordna, Liturgical Town. After reaching the Haligtree, speak to Gideon.",
                "Speak with Milicent at the Prayer Room Grace.",
        ...
        },
        {
            ...
            "tasks": [
                "Speak with everybody in the Roundtable Hold.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Melina at the Frenzied Flame Proscription.",
                "Speak with Hyetta, following her instructions and exhausting her dialogue. If you did not complete Hyetta's questline, you can still go through the door by taking off all of your armor.",
                "Speak with Melina again at the Site of Grace.",
    ...
    "dlc": [
        {
            "title": "Graveside Plain/Cerulean Coast",
            "tasks": [
                "Speak with Leda at the Cocoon of the Empyrean Grace.",
                "Speak with Freyja and Hornsent at the Three-Path Cross Grace.",
                "At Main Gate Cross Grace, purchase something from Moore. Then speak with Moore and Ansbach. Reload the area and speak to Ansbach again.",
                ...
                "Collect the storage room key, on the main path following the Small Private Altar Grace. Then, unlock the door by veering left after the Small Private Altar Grace and speak to Hornsent Grandam.",
                ...
                "Optional: Summon Freyja to fight the Dancing Lion. Then speak with her at the Three-Path Cross Grace.",
                "Return to speak to Hornsent Grandam wearing the Divine Beast Head. Exhaust her dialogue, reload the area, Then speak with her again. Then speak with Hornsent and give him the soup. You can return to Hornsent Grandam for more soup any time you're out. Hornsent won't take any more, but you can offer it again for more dialogue.",
                "Speak with Thiollier at the Pillar Path Cross Grace. Then speak with Moore at the Main Gate Cross Grace. Return to Thiollier.",
                "Speak with Igon near the Pillar Path Waypoint Grace. Leave and come back to speak to him again.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Leda and Hornsent at the Highcross Road Grace. Then speak with Freyja at Three-Path Cross Grace.",
                ...
                "Pick up the “May the Best Win” gesture at the Highroad Cross Grace. Then speak with Dryleaf Dane at the Moorth Ruins Grace and use the gesture to trigger a duel. After defeating him, collect Dryleaf Arts and Dane's Hat, then speak with Leda at the Highcross Road Grace.",
                ...
                "Speak with Moore once you have Forager Brood cookbooks #1-6. For the endgame consequences of Moore’s choice, see the Enir Ilim section at the bottom. This will be your last chance to speak to Moore, so make sure you exhaust his dialogue.",
                ...
                "Speak with Ymir at the Cathedral of Manus Metyr. Afterward, Jolan will appear by the pillar closest to the graveyard. Exhaust her dialogue, then ask Ymir about her."
            ]
        },
        {
            "title": "Fissure",
            "tasks": [
                "Travel to the southern-most part of the map to reach the Fissure. Then speak with Thiollier.",
                "Optional: Summon Thiollier to fight the Putrescent Knight.",
                "Speak with Thiollier after defeating the Putrescent Knight.",
                "Imbibe the nectar four times. Then speak with Thiollier and exhaust his dialogue.",
        ...
        },
        {
            "title": "Jagged Peak",
            "tasks": [
                "Continue North from the Dragon Pit Terminus to reach the Jagged Peak.",
                "Speak with Igon after defeating the dragon near the Foot of the Jagged Peak Grace.",
        ...
        {
            "title": "Shadow Keep / Upper Ancient Ruins",
            "tasks": [
                "Optional: Summon Freyja and Hornsent to fight the Golden Hippo.",
                "Speak with Leda again about Hornsent.",
                ...
                "Travel to the Abyssal woods to meet Midra Here's how to get there:In the same area with 6 burning boats, find a ladder at the end on the left. Climb down and follow the path through a waterfall and an illusory wall until you find a coffin you can climb in. When you arrive, head South along the western wall and descend down the cliff face until you reach the Darklight Catacombs. Head through the Catacombs to reach the Abyssal Woods on the other side.",
                "Speak with Ansbach in the first floor of the Specimen Storehouse. (If you have the Secret Rite Scroll, wait to give it to Ansbach until after Messmer).",
                "Speak with Freyja by the Storehouse, Seventh Floor Grace.",
                ...
                "Speak with Ansbach about Freyja. Then give him the Secret Rite Scroll, found just past the Fourth Floor Storeroom Grace. Continue forward until you find stairs leading down. Reload the area and speak to him again. Choose whether to give Freyja his message (see Enir Ilim section for engame consequences). If you do, speak to Ansbach again.",
        ...
        },
        {
            "title": "Finger Ruins",
            "tasks": [
                "Follow the Eastern Cerulean coast to the Finger Ruins of Rhia. Use the Hanging Bell. Return to speak to Ymir and Jolan at Manus Metyr.",
                ...
                "Follow the Hinterlands path down to the Finger Ruins of Dheo and use the Hanging Bell. Return to speak to Ymir and Jolan at Manus Metyr.",
                ...
                "Use the Hanging Bell and fight Metyr, Mother of Fingers. Return to examine Ymir’s throne. You will have to fight Count Ymir.",
        ...
        },
        {
            ...
            "tasks": [
                ...
                "Speak with Ansbach at the top of the elevator after the fight.",
